export const SEO_CONFIG = {
  ...
  pages: {
    home: {
      ...
      keywords: 'Sachin Dilshan, Technical Lead, Frontend Developer, Angular, TypeScript, React, Node.js, UI/UX Design, Sri Lanka, We Make Platforms, Flutter, AWS',
      priority: 1.0,
      changefreq: 'weekly'
    },
    hire: {
  ...
  structuredData: {
    person: {
      ...
      description: 'Technical Lead at We Make Platforms with 5+ years of experience in Frontend Development, UI/UX Design, and Cloud-based applications.',
    ...
    professionalService: {
      ...
      description: 'Professional Angular consulting services including code audits, performance optimization, UX improvements, and team coaching.',
